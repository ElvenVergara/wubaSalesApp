			 ...
			 <nav class="panel column is-12" style="overflow-x: auto;">
				...
				<div class="panel-block" style="padding:0px;">
				    ...
				    <p class='navbar-end pull-right'>
        			  ...
        			  <p @click="openmodal('stockin_add','')" class="control" title="Add New Data">
                        <a class="button is-info is-rounded is-small" style="width:170px;">
                            <i class="bi bi-plus" style="font-size:38px;"></i> <b>ADD STOCK IN</b>
                        </a>
                      </p>
...
<script type="text/javascript">
    ...
    import ControlModal from '../../Modals/ItemsModal/StockInModal.vue';
    import selectItem from '../../Tables/ItemTables/SelectItemStockIn.vue';
