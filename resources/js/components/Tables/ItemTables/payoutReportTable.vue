      ...
      <div style="width:100%;overflow-y:auto;">
      		 	...
      		 	<table class="table" style="width:100%;">
      			    ...
      			    <tr>
                          ...
                          <div class="field" style="width:50%;float: right;">
                            <label><b>Date To:</b>
                            </label>
                            <div class="control">
      				    ...
      				    <center>
      						...
      						<div style="text-align: right;">
    	       			          ...
    	       			          <label><b style="color:red;">Total Sales:</b>
      	       			          ...
      	       			          <div class="control">
      	       							<b class="title is-1">₱ {{ parseInt(total_sales).toFixed(2).toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",") }}</b>
      	       			          </div>
      	       			        </div>
             			      </div>
            ...
            <div v-if="supplier_id != '0'" v-for="data in alldata" style="padding:10px;">
                ...
                <h1 class="title is-4" style="margin: 0px;">
                    {{ data.title }}
                </h1>
             ...
             <tbody v-else>
                ...
                <h1 class="title is-2" style="text-align:right;padding:0px;margin:0px;">
                    <span style="font-size:20px;color:red;">Total Sales:</span> ₱ {{ parseInt(data.sum).toFixed(2).toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",") }}
                </h1>
    ...
    methods:{
      ...
      print() {
      	...
      	if (this.datefrom != '' && this.dateto != '') {
         	this.$router.push('/printPayout/'+this.datefrom+'/'+this.dateto+'/'+this.supplier_id);
      	} else {
      		this.showToast({
                 type: 'error',
