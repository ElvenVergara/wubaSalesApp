			 ...
			 <nav class="panel column is-12" style="overflow-x: auto;">
				...
				<div class="panel-block" style="padding:0px;">
  					    ...
  					    <p class='navbar-end pull-right'>
		        			  ...
		        			  <p @click="openmodal('customer_add','')" class="control" title="Add New Data">
	                            <a class="button is-info is-rounded is-small" style="width:150px;">
	                                <i class="bi bi-plus" style="font-size:38px;"></i> <b>ADD CUSTOMER</b>
	                            </a>
	                          </p>
										...
										<div class="dropdown-menu" id="dropdown-menu" role="menu" style="padding: 0px; margin-left:-9px;">
												...
												<div class="dropdown-content" style="margin:-20px;width:200px;padding: 0px; margin: 0px;">
														...
														<div class="dropdown-item" style="padding:4px;text-align:center;">
															...
															<a @click="openmodal('customer_block',list.id)" class="button is-danger is-small is-rounded" title="Block">
							        			  			...
							        			  			<a @click="openmodal('customer_edit',list.id)" class="button is-info is-small is-rounded" title="Update">
							        							<i class="bi bi-pencil-square" style="font-size:20px;"></i>
							        			  			</a>

							        			  			&nbsp;

									        			    <a @click="openmodal('customer_delete',list.id)" class="button is-danger is-small is-rounded" title="Delete">
...
<script type="text/javascript">
    ...
    import ControlModal from '../../Modals/UsersModal/CustomersModal.vue';
