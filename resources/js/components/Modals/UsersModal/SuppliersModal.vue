	...
	<div>
			...
			<div v-if="modalData.controltype == 'add'">
              ...
              <form v-on:submit.prevent="onSubmit('add')">
		        ...
		        <div class="field">
		          <label>Company Name <b style="color:red;">*</b>
      				 <a class="delete is-pulled-right" aria-label="close" @click="formdata.company = ''"></a>
		          </label>
		          <div class="control">
						<input v-model='formdata.company' placeholder="Type Here.." class="input" type="text" required>
		          </div>
		        </div>
